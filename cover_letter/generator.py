...
def clean_cover_letter(text, today_str=None):
    ...
    # Force replace any other date string generated by AI (e.g. "July 21, 2026") with actual current date
    date_pattern = r'\b(?:January|February|March|April|May|June|July|August|September|October|November|December)\s+\d{1,2},\s+\d{4}\b'
    text = re.sub(date_pattern, today_str, text)
...
2. DATE: The current date is {today_str}. You MUST write exactly "{today_str}" as the date in the cover letter. Do NOT use any other date, and do NOT use bracketed placeholders.

3. NO MARKDOWN: Do NOT use asterisks (** or *), hashes (#), bullet points with asterisks, or any markdown formatting. Output plain formatted text ONLY.

4. NO PLACEHOLDERS: Do NOT use bracketed placeholders like [Company Name], [Hiring Manager], [Date], [Your Name], [Number] years. Automatically extract or infer the Job Title and Company Name from the Job Description. If company name is not mentioned, address to "Dear Hiring Team,".

5. NO INTRO CHATTER: Do NOT include any intro notes like "Here is your cover letter" or "I have drafted...". Start directly with candidate contact header, date, recipient greeting, and letter content.

6. PERSUASIVE & OPTIMIZED: Craft a compelling narrative demonstrating strong alignment with the job requirements. Keep it professional, punchy, and under 350 words.
...
"""
    ...
    return clean_cover_letter(raw_text, today_str)
