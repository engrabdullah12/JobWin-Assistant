...
# if jd_file:
#     with open("data/uploads/jd.pdf", "wb") as f:
#         f.write(jd_file.read())
#     st.session_state.jd_text = extract_text_from_pdf("data/uploads/jd.pdf")
...
#                     st.error(skill)
#     else:
#         st.info("Upload your Resume and Job Description from the sidebar to get started!")
...
#             st.download_button("Download", letter, file_name="cover_letter.txt")
#     else:
#         st.warning("Please upload both Resume and JD from the sidebar first.")
